...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">monitoramento-switches documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AcessSwitchComponent.html" data-type="entity-link" >AcessSwitchComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/AcessPort.html" data-type="entity-link" >AcessPort</a>
                            </li>
                            <li class="link">
                                <a href="classes/Switch.html" data-type="entity-link" >Switch</a>
                            </li>
                            <li class="link">
                                <a href="classes/UplinkPort.html" data-type="entity-link" >UplinkPort</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/ApiObservableService.html" data-type="entity-link" >ApiObservableService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/HttpRequestService.html" data-type="entity-link" >HttpRequestService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/SwitchProcessorService.html" data-type="entity-link" >SwitchProcessorService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/PortList.html" data-type="entity-link" >PortList</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ValidActivePort.html" data-type="entity-link" >ValidActivePort</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
